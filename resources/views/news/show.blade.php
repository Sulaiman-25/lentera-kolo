        ...
        <div class="container py-5">
            <ol class="breadcrumb justify-content-start mb-4">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('news.viewCategory', $news->category->slug) }}">{{ $news->category->name }}</a></li>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex mt-3 flex-wrap">
                            <div class="text-dark me-4 mb-2"><i class="fa fa-clock"></i>
                                {{ $news->created_at->translatedFormat('d F Y H:i') }}</div>
                            <div class="text-dark me-4 mb-2"><i class="fa fa-eye"></i> {{ $news->views }}</div>
                            <div class="text-dark me-4 mb-2"><i class="fa fa-thumbs-up"></i> {{ $news->likes->count() }}
                            </div>
                            <div class="text-dark mb-2"><i class="fa fa-user"></i> {{ $news->author->name }}</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <!-- Facebook -->
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}&quote={{ urlencode($news->title) }}"
                                    target="_blank"
                                ...
                                <button type="button"
                                    ...
                                    data-title="{{ $news->title }}" data-url="{{ url()->current() }}">
                    ...
                    <div class="tab-class mb-5">
                        <div class="d-flex justify-content-between border-bottom mb-4 flex-wrap">
                            <ul class="nav nav-pills d-inline-flex text-center mb-2">
                                ...
                                <li class="nav-item mb-3">
                                    <a href="{{ route('news.viewCategory', $news->category->slug) }}"
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <form action="{{ route('news.like', $news->id) }}" method="POST" class="like-form">
                                    @csrf
                                    @php
                                ...
                                <span class="ms-1 like-count">{{ $news->likes->count() }}</span>
                            </div>
                        </div>
                            ...
                            <div class="tab-pane fade show active">
                                <div class="row g-4 align-items-center">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <p class="mb-0">{{ $news->author->bio ?? 'Penulis di Portal Berita' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="comments-section bg-white rounded-lg shadow-lg p-5 mt-6">
                        <div class="d-flex align-items-center mb-5 pb-3 border-bottom">
                            <h3 class="h4 fw-bold text-gray-800 mb-0">
                                ...
                                Komentar (<span id="commentsCount">{{ $news->comments_count }}</span>)
                            </h3>
                        </div>
                        ...
                        <div id="commentsList" class="comments-list">
                            @forelse($news->comments->whereNull('deleted_at') as $comment)
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center p-3 bg-white rounded h-100">
                                        <div class="flex-shrink-0">
                                            <img src="{{ $random->image ? asset('storage/images/' . $random->image) : asset('img/noimg.jpg') }}"
                                                class="img-fluid rounded" alt=""
                                                style="width: 100px; height: 100px; object-fit: cover;">
                                        </div>
                                        <div class="ms-3">
                                            <a href="{{ route('news.show', $random->slug) }}"
                                                class="h6 mb-2 d-block">{{ Str::limit($random->title, 50, '...') }}</a>
                                            <p class="text-dark mt-2 mb-0">
                                                <i class="fa fa-clock"></i>
                                                {{ $random->created_at->translatedFormat('d F Y') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
