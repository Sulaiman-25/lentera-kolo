                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        @if ($news->status == 'Accept')
                            <a href="{{ route('admin.news.manage') }}">Manage (Diterima)</a>
                        @else
                            <!-- PERBAIKAN: route('admin.news.status') -->
                            <a href="{{ route('admin.news.status') }}">Status Review</a>
                        @endif
                    </li>
                    <li class="separator">
                        <i class="icon-arrow-right"></i>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="card-title mb-0">{{ $news->title }}</h4>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-2">
                                                    <strong>Email:</strong>
                                                    <p class="mb-0">{{ $news->author->email }}</p>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <strong>Tanggal Kirim:</strong>
                                                    <p class="mb-0">{{ $news->created_at->format('d F Y H:i') }}</p>
                                                </div>
                                                <div class="col-12">
                                                    <strong>Terakhir Diupdate:</strong>
                                                    <p class="mb-0">{{ $news->updated_at->format('d F Y H:i') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-2">
                                                    <strong>Views:</strong>
                                                    <span class="badge bg-secondary">{{ $news->views }}</span>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <strong>Karakter:</strong>
                                                    <span class="badge bg-secondary">{{ strlen($news->content) }}</span>
                                                </div>
                                                <div class="col-12">
                                                    <strong>ID:</strong>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                <div>
                                    @if ($news->status == 'Accept')
                                        <a href="{{ route('news.show', $news->slug) }}" class="btn btn-outline-info"
                                            target="_blank">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    @else
                                        <!-- PERBAIKAN: route('admin.news.status') -->
                                        <a href="{{ route('admin.news.status') }}" class="btn btn-secondary">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.status-btn').click(function() {
                ...
                const url = "{{ route('admin.news.updateStatus', ':id') }}".replace(':id', id);
            ...
            $('.delete-btn').click(function() {
                ...
                const url = "{{ route('admin.news.destroy', ':id') }}".replace(':id', id);
