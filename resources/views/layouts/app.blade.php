...
<head>
    ...
    <link rel="icon" href="{{ asset('img/lentera.jpg') }}" type="image/x-icon" />
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light navbar-expand-xl">
                    <a href="{{ route('index') }}" class="navbar-brand d-block">
                        <img src="{{ asset('img/lentera.jpg') }}" alt="" class="img-fluid"
                                ...
                                <div class="navbar-nav mx-lg-4 border-top"
                                    ...
                                    @foreach (\App\Models\Category::all() as $category)
                                        <a href="{{ route('news.viewCategory', $category->slug) }}"
                                            class="nav-item nav-link mt-2">{{ $category->name }}</a>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="nav-main-links">
                                <ul
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('index') }}" class="nav-link text-secondary fs-5">Beranda</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('kontak') }}" class="nav-link text-secondary fs-5">Kontak
                                            Kami</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('tentang') }}" class="nav-link text-secondary fs-5">Tentang
                                            Kami</a>
                                    </li>
                                    <li class="nav-item">
