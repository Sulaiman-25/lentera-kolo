...
<div class="row g-4 mb-4">
    <?php $__currentLoopData = \App\Models\News::where('status', 'Accept')->inRandomOrder()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-12">
            <div class="row g-4 align-items-center features-item">
                ...
                <div class="col-8">
                    <div class="features-content d-flex flex-column">
                        <p class="text-uppercase mb-2"><?php echo e($news->category->name); ?></p>
                        <a href="<?php echo e(route('news.show', $news->slug)); ?>" class="h6">
                            <?php echo e(Str::limit($news->title, 40, '...')); ?>

                        </a>
                        <small class="text-body d-block"><i class="fas fa-calendar-alt me-1"></i>
                            <?php echo e($news->created_at->translatedFormat('d F Y')); ?></small>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\website\lentera-kolo\resources\views/components/col-2.blade.php ENDPATH**/ ?>
