    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <ol class="breadcrumb justify-content-start mb-4">
                <li class="breadcrumb-item"><a href="<?php echo e(route('index')); ?>">Beranda</a></li>
                <li class="breadcrumb-item"><a
                        href="<?php echo e(route('news.viewCategory', $news->category->slug)); ?>"><?php echo e($news->category->name); ?></a></li>
                <li class="breadcrumb-item active text-dark"><?php echo e($news->title); ?></li>
            </ol>
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="mb-4">
                        <h1 class="display-5"><?php echo e($news->title); ?></h1>
                        <div class="d-flex mt-3 flex-wrap">
                            <div class="text-dark me-4 mb-2"><i class="fa fa-clock"></i>
                                <?php echo e($news->created_at->translatedFormat('d F Y H:i')); ?></div>
                            <div class="text-dark me-4 mb-2"><i class="fa fa-eye"></i> <?php echo e($news->views); ?></div>
                            <div class="text-dark me-4 mb-2"><i class="fa fa-thumbs-up"></i> <?php echo e($news->likes->count()); ?>

                            </div>
                            <div class="text-dark mb-2"><i class="fa fa-user"></i> <?php echo e($news->author->name); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <!-- Facebook -->
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>&quote=<?php echo e(urlencode($news->title)); ?>"
                                    target="_blank"
                                ...
                                <!-- Twitter -->
                                <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($news->title)); ?>"
                                    target="_blank"
                                ...
                                <!-- WhatsApp -->
                                <a href="https://wa.me/?text=<?php echo e(urlencode($news->title . ' - ' . url()->current())); ?>"
                                    target="_blank"
                                ...
                                <!-- Telegram -->
                                <a href="https://t.me/share/url?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($news->title)); ?>"
                                    target="_blank"
                                    class="btn btn-sm btn-primary d-flex align-items-center px-3 py-2 share-btn">
                                ...
                                <!-- Instagram -->
                                <button type="button"
                                    class="btn btn-sm btn-danger d-flex align-items-center px-3 py-2 share-btn instagram-share"
                                    data-title="<?php echo e($news->title); ?>" data-url="<?php echo e(url()->current()); ?>">
                    ...
                    <div class="tab-class mb-5">
                        <div class="d-flex justify-content-between border-bottom mb-4 flex-wrap">
                            <ul class="nav nav-pills d-inline-flex text-center mb-2">
                                ...
                                <li class="nav-item mb-3">
                                    <a href="<?php echo e(route('news.viewCategory', $news->category->slug)); ?>"
                                        class="d-flex py-2 bg-light rounded-pill active me-2">
                                        <span class="text-dark" style="width: 100px;"><?php echo e($news->category->name); ?></span>
                                    </a>
                                </li>
                            </ul>
                            <div class="d-flex align-items-center mb-2">
                                <form action="<?php echo e(route('news.like', $news->id)); ?>" method="POST" class="like-form">
                                    <?php echo csrf_field(); ?>
                                    <?php
                                        $userLiked = auth()->check()
                                            ? $news->likes->where('user_id', auth()->id())->count() > 0
                                            : false;
                                    ?>
                                ...
                                <span class="ms-1 like-count"><?php echo e($news->likes->count()); ?></span>
                            </div>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="row g-4 align-items-center">
                                    <div class="col-3">
                                        <img src="<?php echo e($news->author->image ? asset('storage/images/' . $news->author->image) : asset('img/default.jpeg')); ?>"
                                            class="img-fluid w-100 rounded" alt=""
                                            style="width: 100px; height: 100px; object-fit: cover;">
                                    </div>
                                    <div class="col-9">
                                        <h3><?php echo e($news->author->name); ?></h3>
                                        <p class="mb-0"><?php echo e($news->author->bio ?? 'Penulis di Portal Berita'); ?>
                    ...
                    <div class="comments-section bg-white rounded-lg shadow-lg p-5 mt-6">
                        <div class="d-flex align-items-center mb-5 pb-3 border-bottom">
                            <h3 class="h4 fw-bold text-gray-800 mb-0">
                                ...
                                Komentar (<span id="commentsCount"><?php echo e($news->comments_count); ?></span>)
                            </h3>
                        </div>
                        ...
                        <div class="comment-form mb-6 bg-light rounded p-4 border">
                            ...
                            <form id="commentForm" action="<?php echo e(route('comments.store')); ?>" method="POST">
                                ...
                                <input type="hidden" name="commentable_id" value="<?php echo e($news->id); ?>">
                        ...
                        <div id="commentsList" class="comments-list">
                            <?php $__empty_1 = true; $__currentLoopData = $news->comments->whereNull('deleted_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-light rounded my-4 p-4">
                        <h4 class="mb-4">Mungkin Anda Suka</h4>
                        <div class="row g-4">
                            <?php $__currentLoopData = $randomNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $random): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center p-3 bg-white rounded h-100">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e($random->image ? asset('storage/images/' . $random->image) : asset('img/noimg.jpg')); ?>"
                                                class="img-fluid rounded" alt=""
                                                style="width: 100px; height: 100px; object-fit: cover;">
                                        </div>
                                        <div class="ms-3">
                                            <a href="<?php echo e(route('news.show', $random->slug)); ?>"
                                                class="h6 mb-2 d-block"><?php echo e(Str::limit($random->title, 50, '...')); ?></a>
                                            <p class="text-dark mt-2 mb-0">
                                                <i class="fa fa-clock"></i>
                                                <?php echo e($random->created_at->translatedFormat('d F Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\website\lentera-kolo\resources\views/news/show.blade.php ENDPATH**/ ?>
